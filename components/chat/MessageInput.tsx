...
export function MessageInput({ onSendMessage, disabled, isRestricted, onInputBlur }: MessageInputProps) {
  ...
  return (
    <div ref={inputContainerRef} className="p-4 border-t border-border bg-card min-w-0 overflow-hidden dark:border-[#2d3055] dark:bg-[#171936] md:dark:border-border md:dark:bg-card">
      {isRestricted && (
        ...
        <div className="flex gap-2 items-center min-w-0">
          ...
          <div className="relative flex-shrink-0">
            <button
              ...
              className="p-2 hover:bg-accent dark:hover:bg-[#262a52] md:dark:hover:bg-accent rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <input
            ...
            className="flex-1 min-w-0 px-4 py-2 border border-input rounded-full bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring disabled:opacity-50 disabled:cursor-not-allowed dark:border-[#4d5280] dark:bg-[#11132c] dark:text-[#f5f6ff] dark:placeholder:text-[#9ca1c8] dark:focus:ring-[#d837b8] md:dark:border-input md:dark:bg-background md:dark:text-foreground md:dark:placeholder:text-muted-foreground md:dark:focus:ring-ring"
          />
          ...
          <button
            ...
            className="flex-shrink-0 px-6 py-2 bg-primary text-primary-foreground rounded-full hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium dark:bg-[#d837b8] dark:text-white dark:hover:bg-[#c533a7] md:dark:bg-primary md:dark:text-primary-foreground md:dark:hover:bg-primary/90"
          >
            Versturen
          </button>
        </div>
